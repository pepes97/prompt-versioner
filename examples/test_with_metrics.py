...
def main():
    ...
    version_id = pv.save_version(
        name="code_reviewer",
        system_prompt="You are an expert code reviewer. Analyze code for quality, bugs, and security.",
    ...
    for i in range(10):
        ...
        print(f"   Call {i+1}: {metrics['input_tokens']} in + {metrics['output_tokens']} out = "
    ...
    for i in range(8):
        ...
        print(f"   Call {i+1}: quality={metrics['quality_score']:.2f}, "
